...
const _onSuccessSpyFns : Array<Function> = []
...
function instrumentJQuery() {
    ...
    const handler = {
        get: function (target, prop, receiver) {
            ...
            const resolvedProp = Reflect.get(target, prop, receiver) // Get the "actual" property on the underlying proxied object.
            ...
            if (prop === "ajax") {
                ...
                return function instrumented() {
                    ...
                    const settings = arg0 // arg0 is the "settings" object that the "ajax" function takes. See https://api.jquery.com/jquery.ajax/
                    ...
                    settings.success = new Proxy(success, {
                        apply(target, thisArg, argumentsList) {
                            const responseData = argumentsList[0]

                            for (const spyFn of _onSuccessSpyFns) {
                                spyFn(responseData)
                            }
