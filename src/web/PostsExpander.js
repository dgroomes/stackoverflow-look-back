...
class PostsExpander {
     ...
     * @return {Promise<void>} a promise that resolves when the posts data is successfully expanded
     */
    async expandPosts() {
        ...
        console.info(`The posts data has been successfully expanded for ${idsSorted.length} posts`)
        await promise
    }
}
